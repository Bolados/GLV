...
DR_EXPLAIN.tabController = (function () {
    var _class = {
        ...
        showTabByIndex: function (index) {
            ...
            $tabSelector.addClass("m-tabs__selectorItem__selected").removeClass("m-tabs__selectorItem__hovered").removeClass("m-tabs__selectorItem__unselected");
        ...
        hideTabByIndex: function (index) {
            ...
            $tabSelector.removeClass("m-tabs__selectorItem__selected").addClass("m-tabs__selectorItem__unselected");
    ...
    var _class = {
        ...
        recalculateNavMaxWidth: function () {
            ...
            if (this.dom.$headerSide__nav.length) {
                ...
                this.dom.$headerSide__nav__breadCrumbs.find("li").each(function (index) {
                    maxBreadCrumbWidth = Math.max(maxBreadCrumbWidth, $(this).outerWidth())
                });
